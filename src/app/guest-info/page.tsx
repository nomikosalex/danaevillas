...
export default function GuestInfoPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f5f0eb] text-[#1a1a1a] font-sans">
      ...
      {/* Header */}
      <header className="px-6 pt-12 pb-10 border-b border-[#1a1a1a]/10">
        <p className="text-[10px] uppercase tracking-[0.5em] text-[#8a7e74] mb-4">Santorini, Greece</p>
        <h1 className="text-3xl font-serif font-bold tracking-tight leading-tight mb-1">
          Danae Villa
        </h1>
        <p className="text-[#8a7e74] text-sm font-light">Guest Information</p>
      </header>

      {/* Welcome */}
      <section className="px-6 py-10 border-b border-[#1a1a1a]/10">
        <span className="block text-[10px] uppercase tracking-[0.4em] text-[#8a7e74] mb-4">Welcome</span>
        <p className="text-[#1a1a1a]/70 text-base font-light leading-relaxed">
      ...
      {wifi.enabled && wifi.password && (
        <section className="px-6 py-10 border-b border-[#1a1a1a]/10">
          <span className="block text-[10px] uppercase tracking-[0.4em] text-[#8a7e74] mb-6">Wi-Fi</span>
          <div className="space-y-3">
            <div>
              <p className="text-[#8a7e74] text-[10px] uppercase tracking-widest mb-1">Network</p>
              <p className="text-[#1a1a1a] text-sm">{wifi.network}</p>
            </div>
            <div>
              <p className="text-[#8a7e74] text-[10px] uppercase tracking-widest mb-1">Password</p>
      ...
      {/* Daily Schedule */}
      <section className="px-6 py-10 border-b border-[#1a1a1a]/10">
        <span className="block text-[10px] uppercase tracking-[0.4em] text-[#8a7e74] mb-6">Daily Schedule</span>
      ...
      {/* House Regulations */}
      <section className="px-6 py-10 border-b border-[#1a1a1a]/10">
        <span className="block text-[10px] uppercase tracking-[0.4em] text-[#8a7e74] mb-6">House Regulations</span>
        <div className="space-y-4">
      ...
      {/* Contact */}
      <section className="px-6 py-10 border-b border-[#1a1a1a]/10">
        <span className="block text-[10px] uppercase tracking-[0.4em] text-[#8a7e74] mb-6">Need Assistance?</span>
        <p className="text-[#1a1a1a]/60 text-sm font-light mb-6 leading-relaxed">
          Our team is available at any time. Message us on WhatsApp and we will
          respond as soon as possible.
        </p>
        <div className="mb-5">
          <p className="text-[#8a7e74] text-[10px] uppercase tracking-widest mb-1">Your Host</p>
      ...
      <footer className="px-6 py-8 text-center">
        <p className="text-[#8a7e74] text-[10px] uppercase tracking-[0.3em]">Danae Villa · Fira, Santorini</p>
      </footer>
